...
class FloatLabelTextView: UITextView {
    ...
    let placeholderTextColor = UIColor.black.withAlphaComponent(0.5)
    ...
    // @IBInspectable
    var titleTextColour:UIColor = UIColor.white.withAlphaComponent(0.6) {
        didSet {
            if !isFirstResponder {
    ...
    //@IBInspectable 
    var titleActiveTextColour:UIColor = UIColor.white {
        didSet {
            if isFirstResponder {
    ...
    override func layoutSubviews() {
        ...
        //
        self.textColor = UIColor.black.withAlphaComponent(0.6)
    }
